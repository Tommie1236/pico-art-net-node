...
def draw_buttons():
    ...
    text1 = font.render("Button 1", True, BUTTON_TEXT_COLOR)
    text2 = font.render("Button 2", True, BUTTON_TEXT_COLOR)
    text3 = font.render("Button 3", True, BUTTON_TEXT_COLOR)
    text4 = font.render("Button 4", True, BUTTON_TEXT_COLOR)
